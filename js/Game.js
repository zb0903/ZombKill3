...
weapon1.addImage("weapon1", bulletImage);
weapon1.scale = 0.1;
weapon1.visible = false;

weapon2 = createSprite(width / 2 + 100, height - 100);
weapon2.addImage("weapon2", fireballImage);
weapon2.scale = 0.1;
...
//To do: evaluate whether u need it: don't think so...
  ...
  handleAttackControls() {
    ...
    if ((player.index==1 && player.bullets > 0) || (player.index == 2 && player.fireballs > 0) ){
      ...
      if (keyDown("w") && this.weaponMovingDir== null) {
        ...
        if (player.index == 2) player.fireballs--;
        else
        player.bullets--;    
      }
